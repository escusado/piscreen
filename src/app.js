...
module.exports = class App {
  ...
  setupFrame () {
    ...
    const colorScale = Chroma.scale(['#000033', '#330000', '#003300', '#000033']).mode('rgb').colors(Engine.pixelCount)
    let colorIndex = 0;
    for (let y=0; y<Engine.height; y++) {
      ...
      for (let x=0; x<Engine.width; x++) {
        ...
        //borders
        this.frame[y][x] = y===0 || x===0 || y===(Engine.height-1) || x===(Engine.width-1) ? '#333333' : colorScale[colorIndex];
